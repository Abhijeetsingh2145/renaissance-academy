  ...
  return (
    <div className="p-6 md:p-10 max-w-7xl mx-auto space-y-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-neutral-200 pb-5">
        <div>
          <h1 className="text-3xl font-bold text-neutral-900">Enquiries & Messages</h1>
          <p className="text-sm text-neutral-500 mt-1">Filter, search, and manage all admission enquiries and website contact form submissions.</p>
        </div>
        <div className="bg-brand-primary text-white text-xs font-bold px-4 py-2 rounded-xl shadow-xs w-fit">
