  ...
  return (
    <>
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-3xl font-bold text-neutral-900">Manage Notices</h1>
        <button
          onClick={handleCreate}
          className="flex items-center space-x-2 bg-brand-primary text-white px-4 py-2 rounded-md hover:bg-brand-800 transition-colors font-medium"
        >
      ...
      {!initialNotices || initialNotices.length === 0 ? (
        <div className="bg-white p-12 rounded-xl border border-neutral-200 text-center shadow-sm">
          <p className="text-neutral-500 mb-4">No notices found.</p>
          <button
            onClick={handleCreate}
        ...
        <div className="bg-white rounded-xl border border-neutral-200 shadow-sm overflow-hidden">
          <div className="overflow-x-auto">
            <table className="w-full text-sm text-left">
              <thead className="bg-neutral-50 text-neutral-600 font-medium border-b border-neutral-200 uppercase text-xs tracking-wider">
                <tr>
